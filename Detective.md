...
- Stuff **Beide Commits sind sehr unverständlich geschrieben**
- Update
...
- Befehl: git log --all --decorate --oneline --graph
- Id: 50da5b1
- Message: Update
- Begründung: daneben steht in einem Tag das es Broken ist
...
- Befehl: git show
- Id: 50da5b1
- Calculator.java; CalculatorText.java
- Beide Files wurden umbenannt und in der Calculator Datei wurde etwas ausgetauscht.
...
- Id: 50da5b1
- Update
- return a/b -> return a/0
- Weil in der Mathematik eine Division durch 0 nicht möglich ist
...
- Unterschied: division wurde von a/b auf a/0 geändert
- Befehl: git diff
